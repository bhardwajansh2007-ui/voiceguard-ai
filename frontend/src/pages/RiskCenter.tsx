  ...
  const signals = [
    {
      ...
      weight: 40,
      description: 'AASIST neural spectral artifact detection. Flags synthetic and vocoded speech. (Replay attack detection: LIMITED / NOT FORMALLY VALIDATED).',
    ...
    },
    {
      ...
      weight: 25,
      description: '128-D acoustic-prosodic feature cosine distance versus reference enrolled biometric profile.',
